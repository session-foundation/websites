  ...
  return (
    <ChartContext.Provider value={{ config }}>
      <div
        ...
        ref={ref}
        className={cn(
          // biome-ignore lint/nursery/useSortedClasses: DO NOT SORT, it breaks the shadcn magic
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-border/50 bg-session-black px-2.5 py-1.5 text-xs shadow-xl",
          className
        )}
      >
        {!nestLabel ? tooltipLabel : null}
        <div className="grid gap-1.5">
          {/* biome-ignore lint/complexity/noExcessiveCognitiveComplexity: from shadcn, it works */}
