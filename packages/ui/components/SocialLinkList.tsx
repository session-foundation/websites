      ...
      {socialLinks?.map((item, index) => {
        ...
        return (
          <li key={`${index}-${name}-${link}`}>
            <a
              className={cn(
                'flex h-9 w-9 items-center justify-center rounded-full border border-session-green bg-session-black fill-session-white transition-colors duration-200 *:h-4 *:w-4',
